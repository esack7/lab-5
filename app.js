...
testSum(4, 7);//Done in class already!
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  // console.log(product);
  var third = a + ' and ' + b + ' and ' + c + ' sum to ' + add + '.';
  // console.log(third);
...
testSumAndMultiply(4,7,5);//Test 3 completed
...
function sumArray(testArray){ //eslint-disable-line
  ...
  console.log(add);
  var message = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + add + ' is their sum.';
  return[add,message];
}

// TODO: Here is the test for sumArray(); uncomment it to run it
testSumArray(testArray);//completed #4
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + times + '.';
  console.log(message);
  return[times,message];
}

// Here is the test for multiplyArray(); uncomment it to run it
testMultiplyArray(2,3,4);//completed #5
